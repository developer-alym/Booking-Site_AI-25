# Generated by Django 6.0.1 on 2026-01-10 06:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_role', models.CharField(choices=[('client', 'client'), ('owner', 'owner')], default='client', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room_type', models.CharField(choices=[('Семейный', 'Семейный'), ('Одноместный', 'Одноместный'), ('Двухместный', 'Двухместный'), ('Люкс', 'Люкс')], max_length=15)),
                ('room_status', models.CharField(choices=[('Свободень', 'Свободень'), ('Забронировань', 'Забронировань')], default='Свободень', max_length=15)),
                ('hotel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hotel_app.hotel')),
            ],
        ),
        migrations.CreateModel(
